    ...
    try:
        ...
        if amount <= 10:
            ...
            message = (
                f"**Card Generator** 💳\n"
                f"━━━━━━━━━━━━━━━━━\n"
                f"ᛋ Bin: `{bin_number}xxxx|mm|yyyy|cvv`\n"
                f"━━━━━━━━━━━━━━━━━\n"
                f"{card_lines}\n"
                f"━━━━━━━━━━━━━━━━━\n"
            ...
            file_bytes.name = f'generated_cards_{bin_number}.txt'
            ...
            await update.message.reply_document(
                document=file_bytes,
                filename=f'generated_cards_{bin_number}.txt',
                caption=caption,
                parse_mode='Markdown'
            )
...
async def check_crunchyroll_mass(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Send a text file with accounts in format:\n"
...
def main():
    ...
    application.add_handler(CommandHandler("mcr", check_crunchyroll_mass))
